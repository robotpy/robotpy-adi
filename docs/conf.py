...
version = ".".join(adis16470.version.version.split(".")[:2])
# The full version, including alpha/beta/rc tags.
release = adis16470.version.version
...
gen_package(root, "adis16448")
gen_package(root, "adis16470")
